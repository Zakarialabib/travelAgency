...
return [
    ...
    'url' => env('XTRAVEL_URL', null),
    'agence_code' => env('XTRAVEL_AGENCY_CODE', null),
    'brand_code' => env('XTRAVEL_BRAND_CODE', null),
    'point_of_sale_id' => env('XTRAVEL_POINT_OF_SALE_ID', null),
    'xtravel_default_language' => env('XTRAVEL_DEFAULT_LANG', 'fr'),
    /*
    |--------------------------------------------------------------------------

...
<section>
    ...
    <div class="container">
        ...
        <div class="alert alert-success success-import" style="display:none;">
            <p>{{ __('Done importing, processed') }} <strong class="counter">N</strong>
                {{ __('items! Reload this page to refresh the groups') }}!</p>
        </div>
        <div class="alert alert-success success-find" style="display:none;">
            <p>{{ __('Done searching for translations, found') }} <strong class="counter">N</strong>
                {{ __('items') }}!</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <button type="submit" class="btn btn-success btn-block"
                            data-disable-with="Loading..">{{ __('Import groups') }}</button>
                    </div>
                </div>
            </div>
        </form>
        <form class="form-find" method="POST"
            ...
            <div class="form-group">
                ...
                <button type="submit" class="btn btn-info"
                    data-disable-with="Searching..">{{ __('Find translations in files') }}</button>
            </div>
        </form>
        <?php endif; ?>
        <?php if (isset($group)): ?>
        <form class="form-inline form-publish" method="POST"
            ...
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
            <button type="submit" class="btn btn-info"
                data-disable-with="Publishing..">{{ __('Publish translations') }}</button>

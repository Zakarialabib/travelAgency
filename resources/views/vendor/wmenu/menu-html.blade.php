												...
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name"> <span>{{__('Name')}}</span>														
															...
															<input name="menu-name" id="menu-name" type="text" class="menu-name regular-text menu-item-textbox" title="{{__('Enter menu name')}}" value="@if(isset($indmenu)){{$indmenu->name}}@endif">
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="field-css-url description description-wide">
																		<label for="edit-menu-item-url-{{$m->id}}"> {{__('URL')}}</label>
																			<br>
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a onclick="getmenus()" class="button button-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">{{__('Update item')}}</a>

...
<!-- JQVMap -->
<script type="text/javascript"  src="{{asset('/admin/vendors/jqvmap/dist/jquery.vmap.js')}}"></script>
<script type="text/javascript"  src="{{asset('/admin/vendors/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
<script type="text/javascript"  src="{{asset('/admin/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js')}}"></script>
<script type="text/javascript"  src="{{asset('/admin/vendors/morris.js/morris.min.js')}}"></script>
<!--dataTables-->
...
<script type="text/javascript"  src="{{asset('/admin/build/js/custom.min.js')}}"></script>
<script type="text/javascript"  src="{{asset('/admin/js/commons.js')}}"></script>

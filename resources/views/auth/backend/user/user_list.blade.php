                    ...
                    <table class="table table-striped table-bordered golo-datatable">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>{{$user->role}}</td>
                                <td>
                                    <input type="checkbox" class="js-switch user_status" data-id="{{$user->id}}" {{isChecked($user->status, \App\User::STATUS_ACTIVE)}}/>
                                </td>
                                <td>
                                    <input type="checkbox" class="js-switch user_admin" data-id="{{$user->id}}" {{isChecked($user->is_admin, \App\User::USER_ADMIN)}}/>
                                </td>

                            ...
                            @foreach($languages as $index => $language)
                                ...
                                <div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="post_title_{{$language->code}}">Title<small>({{$language->code}})</small>: *</label>
                                    ...
                                    <div class="form-group">
                                        <label for="post_content_{{$language->code}}">Content<small>({{$language->code}})</small>:</label>

            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title title_left mt-1">{{ __('Add faq') }}</h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('faq.store') }}" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="content" class="form-control tinymce_editor"  rows="3" placeholder="{{ __('Content') }}">{{ old('content') }}</textarea>

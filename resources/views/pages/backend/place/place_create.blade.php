                                                ...
                                                @foreach($languages as $index => $language)
                                                    <div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="{{$language->code}}[name]" required placeholder="{{__('What the name of place')}}" autocomplete="off" {{$index !== 0 ?: "required"}}>
                                                        </div>
                                ...
                                <p class="lead">{{__('itinerary')}}</p>
                                    <div id="itinerary_list">
                                                <div class="row form-group itinerary_item" id="itinerary_item_0">
                                                    <div class="col-md-11">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" name="itinerary[0][question]" placeholder="{{__('Enter Day')}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control tinymce_editor" name="itinerary[0][answer]" rows="3" placeholder="Enter Description">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">

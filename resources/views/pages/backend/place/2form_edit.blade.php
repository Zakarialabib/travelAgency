<form action="{{route('place_create')}}" enctype="multipart/form-data" method="post">
    ...
    <div class="tab-content">
        ...
        <div id="opening_hours">
            ...
            <button type="button" class="btn btn-round btn-default" id="openinghour_addmore">+{{__('Add more')}}</button>
        ...
        <div id="menus">
            ...
            <div id="menu_list">
                @if($place->menu)
                    @foreach($place->menu as $key => $menu)
                        <div class="row form-group menu_item" id="menu_item_{{$key}}">
                            <div class="col-md-2">
                                <div class="lfm" data-input="thumbnail_{{$key}}" data-preview="holder_{{$key}}">
                                    ...
                                    <input id="thumbnail_{{$key}}" class="form-control" type="hidden" value="{{$menu['thumb']}}" name="menu[{{$key}}][thumb]">
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="menu[{{$key}}][name]" value="{{$menu['name']}}" placeholder="Menu name">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="menu[{{$key}}][price]" value="{{$menu['price']}}" placeholder="Menu price">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="menu[{{$key}}][description]" value="{{$menu['description']}}" placeholder="Menu description">
                                </div>
                            </div>
                            <div class="col-md-1">
            ...
            <button type="button" class="btn btn-round btn-info" id="menu_addmore">+ {{__('Add more')}}</button>
        </div>
        ...
        <div id="faqs">
                ...
                @if($place->faq)
                    @foreach($place->faq as $key => $menu)
                        <div class="row form-group faq_item" id="faq_item_{{$key}}">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="faq[{{$key}}][question]" value="{{$menu['question']}}" placeholder="Enter question">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="faq[{{$key}}][answer]" value="{{$menu['answer']}}" placeholder="Enter answer">
                                </div>
                            </div>
                            <div class="col-md-1">
            ...
            <button type="button" class="btn btn-round btn-info" id="faq_addmore">+ {{__('Add more')}}</button>
        </div>
        ...
        <div id="link_affiliate">
           <p class="lead">{{__('Booking type')}}</p>
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Booking::TYPE_BOOKING_NOW)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                ...
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Booking::TYPE_BOOKING_FORM)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type"
                           value="{{\App\Booking::TYPE_BOOKING_FORM}}" {{isChecked($place->booking_type, \App\Booking::TYPE_BOOKING_FORM)}}>{{__('Booking form')}}
                </label>
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Booking::TYPE_CONTACT_FORM)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type"
                ...
                <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" name="booking_type" value="{{\App\Booking::TYPE_BANNER}}"
                           class="join-btn" {{isChecked($place->booking_type, \App\Booking::TYPE_BANNER)}}>{{__('Banner link')}}
                </label>
                <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" name="booking_type" value="{{\App\Booking::TYPE_MAP}}"
                           class="join-btn" {{isChecked($place->booking_type, \App\Booking::TYPE_MAP)}}>{{__('Maps')}}
                </label>
            </div>
        </div>

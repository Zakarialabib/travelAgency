            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="email">{{__('Phone Number')}}</div>
                    </div>
                    <div class="col invoice-details">
                        <h1 class="invoice-id">{{__('reference')}} : </h1>
                        <div class="date">Date dՎmission: {{$returns->created_at->toDateString()}}</div>
                    </div>
                </div>
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($returnDetails as $returndetail)
                        <tr>
                            ...
                            <td class="total">{{number_format((float) ($returndetail->total / $returndetail->qty), 2, '.', '')}}</td>
                            <td class="total">{{$returndetail->qty}}</td>
                            <td class="total">{{number_format((float)$returns->tax, 2, '.', '')}}</td>
                            <td class="total">{{number_format((float)$returndetail->total, 2, '.', '')}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td>{{number_format((float)$returns->tax, 2, '.', '')}}</td>
                        </tr>
                        <tr>
                            <td colspan="3"></td>
                            <td colspan="2">TVA</td>
                        ...
                        <tr>
                            ...
                            <td>{{number_format((float)$returns->grand_total, 2, '.', '')}}</td>
                        </tr>
                    </tfoot>
                </table>

                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @foreach($customers as $customer)
                                        <option 
                                        value="{{$customer->id}}"
                                        {{($booking && $booking->user && $booking->user->id === $customer->id) ? 'selected' : ''}}
                                        >{{$customer->profile->sur_name}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered table-hover" id="sale_details">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td>
                                                <input type="text" name='name[]' value="{{$item->name}}" placeholder="{{__('Enter Product Name')}}" class="form-control" autocomplete="off"/>   
                                            </td>
                                            <td>
                                                <input type="number" name='qty[]' value="{{$item->qty}}" placeholder="{{__('Enter Qty')}}" class="form-control qty" step="0" min="0"/>
                                            </td>
                                            <td>
                                                <input type="number" name='price[]' value="{{$item->price}}" placeholder="{{__('Enter Unit Price')}}" class="form-control price"  step="0.00" min="0"/>
                                            </td>
                                            <td>
                                                <input type="number" name='total[]' value="{{$item->qty * floatval($item->price)}}" placeholder='0.00' class="form-control total" readonly/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <input type="text" name='name[]'  placeholder="{{__('Enter Product Name')}}" class="form-control" autocomplete="off"/>   
                                            </td>
                                            <td>
                                                <input type="number" name='qty[]' placeholder="{{__('Enter Qty')}}" class="form-control qty" step="0" min="0"/>
                                            </td>
                                            <td>
                                                <input type="number" name='price[]' placeholder="{{__('Enter Unit Price')}}" class="form-control price"  step="0.00" min="0"/>
                                            </td>
                                            <td>
                            ...
                            <table class="table table-bordered table-hover" id="tab_logic_total">
                                ...
                                <tbody>
                                    ...
                                    <td class="text-center"><div class="input-group mb-2 mb-sm-0">
                                        <input type="number" class="form-control" name="tax" id="tax" placeholder="0" value="0" min="0">

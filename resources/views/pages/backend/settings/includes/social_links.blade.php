<div class="tile">
    <form action="{{ route('settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-group">
                <label class="control-label" for="social_youtube">youtube link</label>
                <input
                    class="form-control"
                    type="text"
        ...
        <div class="tile-footer">
            <div class="row d-print-none mt-2">
                <div class="col-12 text-right">
                    <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>{{__('Update Settings')}}</button>
                </div>
            </div>
        </div>
    </form>

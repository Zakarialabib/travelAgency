                        ...
                        <div class="col-md-12 col-sm-12 vertical-tab-pannel">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="col-md-12 clear-padding">
                                        ...
                                        <div id="round_trip_flight_search_holder">
                                            ...
                                            <div class="col-md-2 col-sm-2 search-col-padding">
                                                ...
                                                <div class="input-group">
                                                    <input type="text"
                                                        class="form-control round_trip_return_date date-picker"
                                                ...
                                                <div class="col-md-1 col-sm-1 search-col-padding">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn btn-outline-primary btn-group" id="add_new_trip"
                                                            type="button"><i class="fa fa-plus"></i> {{ __('Add') }}
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="hotel">
                                    <div class="col-md-12">
                                        <form>
                                            <div class="col-md-12 product-search-title">{{ __('Book Hotel Rooms') }}
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-3 search-col-padding">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="check-in" id="check_in"
                                                        class="form-control date-picker check_in_date"
                                                        placeholder="JJ/MM/AAAA">
                                                    <span class="input-group-addon"><i
                                                            class="fa fa-calendar fa-fw"></i></span>
                                                </div>
                    ...
                    @foreach ($places as $place)
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="offer_item">
                                <a href="#" class="place_addwishlist @if ($place->wish_list_count) remove_wishlist active @else @guest open-login @else add_wishlist @endguest @endif"
                                    data-id="{{ $place->id }}" title="Add Wishlist">
                                    <i class="la la-bookmark la-24"></i>
                                </a>
                                <div class="hover_box">
                                    <a title="" href="{{ route('place_detail', $place->slug) }}">
                                        <img src="{{ getImageUrl($place->thumb) }}" alt="{{ $place->name }}"
                                            class="offer-img">
                                        <h4 class="offer_name">{{ $place->name }}</h4>
                                        <div class="offer_info">
                                            <p class="back-line">{{ __('Starting From') }}</p>
                                            <p class="">{{ number_format($place->price) }}DH</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
            ...
            <h2 class="news__title title title--more">
                ...
                <a href="{{ route('post_list_all') }}" title="{{ __('View more') }}">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10">
                        <path fill="#23D3D3" fill-rule="nonzero"
                            d="M5.356 4.64L.862.148A.503.503 0 1 0 .148.86l4.137 4.135L.148 9.132a.504.504 0 1 0 .715.713l4.493-4.492a.509.509 0 0 0 0-.713z" />
                    </svg>
                </a>
            </h2>
                                ...
                                <div class="post__info">
                                    <ul class="post__category">
                                        @foreach ($post['categories'] as $cat)
                                            <li><a title="{{ $cat->name }}"
                                                    href="{{ route('post_list', $cat->slug) }}">{{ $cat->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>

                        ...
                        <div role="tabpanel" class="tab-pane active" id="places">
                            <div class="site__search layout-02">
                                ...
                                <form action="{{route('page_search_listing')}}" class="site-banner__search layout-02">
                                    ...
                                    <div class="field-input">
                                        <input class="site-banner__search__input open-suggestion"
                                            style="background-color: #00000036;text-align: center;" id="location_search"
                                            type="text" name="city_name" placeholder="{{__('City')}}"
                                            autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="offer_item">
                        <a href="#"
                            class="place_addwishlist @if($place->wish_list_count) remove_wishlist active @else @guest open-login @else add_wishlist @endguest @endif"
                            data-id="{{$place->id}}" title="Add Wishlist">
                            <i class="la la-bookmark la-24"></i>
                        </a>
                        <div class="hover_box">
                            <a title="" href="{{route('place_detail', $place->slug)}}">
                                <img src="{{getImageUrl($place->thumb)}}" alt="{{$place->name}}" class="offer-img">

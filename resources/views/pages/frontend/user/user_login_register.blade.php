  ...
  <div class="container-fluid my-5">
    <div class="row">
      <div class="col-md-6 mx-auto">
        <form action="{{route('booking_user_signin')}}" method="POST" style="margin: 3rem 2rem;">
          @csrf
      ...
      <div class="col-md-6">
        <form action="{{route('booking_user_register')}}" method="POST" style="margin: 3rem 2rem;">
          @csrf
          <input type="hidden" name="booking_id" value="{{$booking->id}}">
          <div class="row">
            <div class="form-group col-md-6">

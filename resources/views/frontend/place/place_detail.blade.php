    ...
    <main id="main" class="site-main place-04">
        ...
        <div class="row">
            ...
            <div class="slick-sliders">
                <div class="slick-slider photoswipe" data-item="1" data-arrows="false" data-itemScroll="1" data-dots="false" data-infinite="false" data-centerMode="false" data-centerPadding="0" data-centerpadding="418px" data-tabletitem="1" data-tabletscroll="1" data-tabletpadding="70px"
                    ...
                    @if(isset($place->gallery))
                        ...
                        @endforeach
                    @else
                        <div class="place-slider__item"><a href="#"><img src="https://via.placeholder.com/1280x500?text=Rentacstours" alt="slider no image"></a></div>
                    @endif
                </div>
                ...
                <div class="place_title row">
                <h1>{{$place->name}}</h1>
                <span class="place__reviews__number reviews__number">
												{{$review_score_avg}}
												<i class="la la-star"></i>
											</span>
                                            <span class="place__places-item__count reviews_count">({{count($reviews)}} {{__('reviews')}})</span>
                                        <div class="place__meta">
                                    <div class="place__currency">{{$place->price}}/{{PRICE_RANGE[$place->price_range]}}</div>
                    ...
                    <div class="col-lg-8">
                        <div class="place__left">
                            ...
                            <div class="toggle-show">
                                <h3>{{__('Contact Info')}}  <i class="las la-angle-down"></i></h3>
                              </div>
                            ...
                            @if($have_opening_hour)
                                <div class="place__box place__box-open">
                                                <div class="store-detail">
                                                    ...
                                                    <div class="toggle-select">
                                                        <div class="toggle-show">
                                                       <h3> {{__('Opening Hours')}}   <i class="las la-angle-down"></i></h3>
                                                        </div>
                                                        <div class="toggle-list">
                                                            <ul>
                                                                @foreach($place->opening_hour as $opening)
                                    ...
                                    <div class="review-form">
                                        ...
                                        <form id="submit_review">
                                            ...
                                            <div class="field-textarea">
                                                <img class="author-avatar" src="{{asset(\App\Profile::getUserInfo(auth()->user()->id)->photo)}}" alt="">
                                                <textarea name="comment" placeholder="{{__('Write a review')}}"></textarea>
                                            </div>
                                            <div class="field-submit">
                                                <small class="form-text text-danger" id="review_error">{{__('error!')}}</small>
                            ...
                            @elseif($place->booking_type === \App\Booking::TYPE_CONTACT_FORM)
                                <aside  id="booking"  class="widget widget-shadow widget-booking-form">
                                    ...
                                    <form class="form-underline" id="booking_submit_form" action="" method="post">
                                        ...
                                        <div class="field-input">
                                            <textarea type="text" id="message" name="message" placeholder="{{__('Enter your message')}}"></textarea>
                                        </div>

...
}, function (t, e, n)
{
	...
	function S(t, e, n, o)
	{
		if (!t._disable)
		{
			...
			{
				r = t.render(c, u, f), t.getChildContext && (f = i(i(
				{}, f), t.getChildContext()));
	...
	i(N.prototype,
	{
		setState: function (t, e)
		{
			...
			{}, n)), i(n, "function" == typeof t ? t(n, this.props) : t), e && (this._renderCallbacks = this._renderCallbacks || []).push(e), a(this)
		},
...
}, function (t, e, n)
{
	...
	t.exports = function (t)
	{
		return o(t), t.baseURL && !c(t.url) && (t.url = u(t.baseURL, t.url)), t.headers = t.headers ||
		{}, t.data = i(t.data, t.headers, t.transformRequest), t.headers = r.merge(t.headers.common ||
		{}, t.headers[t.method] ||
		{}, t.headers ||
...
}, function (t, e, n)
{
	...
	e.a = function (t)
	{
		...
		}, e.prototype.render = function (t, e)
		{
			...
			n.wrapperHeight = h;
			var m;
			return m = r || !o && !n.alwaysUseFloatingButton ? o ? f.h : (r || this.state.wasChatOpened) && r ? d(
			{}, f.e, l) : d(
			{}, f.c) : d(
			{}, f.g), Object(i.b)("div",
			{
	...
	e.a = function (t)
	{
		...
		return i(e, t), e.prototype.render = function (t)
		{
			...
			}, "" === e.bubbleAvatarUrl ? Object(o.b)("svg",
			{
				...
				fill: "#FFFFFF",
				height: "24",
				viewBox: "0 0 49 43.79",
				width: "24",
				xmlns: "http://www.w3.org/2000/svg"
			}, Object(o.b)("path",
			{
				d: "M48.5,5.43V26.57a4.93,4.93,0,0,1-4.93,4.93H22.5l-10,11v-11H5.43A4.93,4.93,0,0,1,.5,26.57V5.43A4.93,4.93,0,0,1,5.43.5H43.57A4.93,4.93,0,0,1,48.5,5.43Z"
			}), Object(o.b)("path",
			{
				d: "M0 0h24v24H0z",
				fill: "none"
